...
[official speedtest](https://speed.measurementlab.net).

We also provide a standalone Go client on the [Github repository](https://github.com/m-lab/msak/).
...
* [throughput and latency results](https://console.cloud.google.com/storage/browser/archive-measurement-lab/autoload/v1/msak)
* [sidecar data](https://console.cloud.google.com/storage/browser/archive-measurement-lab/msak), including tcpinfo snapshots
and PCAPs
