---
permalink: internet-preformance-igf
title: Internet performance talk at IGF 2018
excerpt: >-
  In this blog post I’ll share the slides I presented in a session at the 2018
  Internet Governance Forum (IGF) titled Net Neutrality: "Measuring
...
In this blog post I’ll share the slides I presented in a session at the 2018 Internet Governance Forum (IGF) titled [Net Neutrality: "Measuring Discriminatory Practices](https://www.intgovforum.org/multilingual/content/igf-2018-dc-net-neutrality-measuring-discriminatory-practices-dcnn)", along with some extra comments that occurred to me after delivering the talk, when preparing this follow-up blog post.

In my first slide, I recapped [OONI](https://ooni.torproject.org/)'s experience with measuring performance of an [emulated DASH flow](https://en.wikipedia.org/wiki/Dynamic_Adaptive_Streaming_over_HTTP) in collaboration with [Fight for the Future](https://www.fightforthefuture.org/). What we did was basically reimplement [Neubot’s DASH test](https://github.com/ooni/spec/blob/696dcbf76e89ae32f53e7f552a524bed41ee0d05/nettests/ts-021-dash.md) in [Measurement Kit](https://github.com/measurement-kit/measurement-kit) (OONI's measurement library) and run experiments.
