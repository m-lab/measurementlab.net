...
![Hourly test volume](../../assets/images/blog/2023-04-cloud/image01.png){: width="750"}{:style="display:block; margin-left:auto; margin-right:auto"}
...
![Comparison of performance to the cloud NDT server and two physical sites in Mumbai](../../assets/images/blog/2023-04-cloud/image02.png){: width="750"}{:style="display:block; margin-left:auto; margin-right:auto"}
...
![Performance of NDT tests to our server in Google Cloud under different load conditions.](../../assets/images/blog/2023-04-cloud/image03.png){: width="750"}{:style="display:block; margin-left:auto; margin-right:auto"}
...
![Test per hour for Indian sites](../../assets/images/blog/2023-04-cloud/image04.png){: width="750"}{:style="display:block; margin-left:auto; margin-right:auto"}
...
![Performance of NDT tests to our server in Google Cloud before and during the spike in NDT tests on January 25, 2023.](../../assets/images/blog/2023-04-cloud/image05.png){: width="750"}{:style="display:block; margin-left:auto; margin-right:auto"}
