---
permalink: platform-transition-ndt-dataset-tables-views
title: 'Platform Transition Update - NDT Dataset, Tables, & Views'
excerpt: >-
  If you've been following our blog over the last few months, you know M-Lab has
  been working toward a complete server platform upgrade. As of November 20,
  2019, all M-Lab servers are now managed by Kubernetes, running Docker
