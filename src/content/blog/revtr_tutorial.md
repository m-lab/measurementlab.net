...
- **Reverse paths** (client → server) from the RevTr system, stored in BigQuery at _measurement-lab.revtr_raw.revtr1._

- **Forward traceroutes** (server → client) from _Measurement-lab.revtr_raw.trace1._
