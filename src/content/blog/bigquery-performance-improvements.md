---
permalink: bigquery-performance-improvements
title: Announcing improved performance for M-Lab BigQuery data
excerpt: >-
  Today, M-Lab is happy to announce the public beta of new M-Lab BigQuery
  tables. These tables provide substantially improved performance and reduce the
...
We've published a migration guide to help convert your existing M-Lab BigQuery SQL to take advantage of the new, faster tables. Our data schema has not changed, so converting existing queries is easy and straightforward. See the [Legacy Migration Guide](/data/docs/bq/legacymigration) for details.
