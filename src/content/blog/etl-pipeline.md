---
permalink: etl-pipeline
title: New ETL Pipeline and Transition to New BigQuery Tables
excerpt: >-
  Since May 2017, the M-Lab team has been working on an updated, open source
  pipeline, which pulls raw data from our servers, saves it to Google Cloud
  Storage, and then parses it into our BigQuery tables. The team is particularly
