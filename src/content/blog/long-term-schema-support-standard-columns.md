---
permalink: long-term-schema-support-standard-columns
title: Long Term Supported Schemas Using Standardized BigQuery Columns
excerpt: >-
  Following the M-Lab platform upgrade in Nov. 2019, the development team began
  a series of follow up projects to enable access to NDT data for various
  audiences with differing needs. The first step in that process was the
  publication of "unified views", which present the most commonly used fields
  ...
authors:
  - chris-ritzo
published: published
