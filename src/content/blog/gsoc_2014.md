...
excerpt: >-
  We are proud to announce that the M-Lab has been accepted as a mentoring
  organization to the Google Summer of Code a third year in a row.
authors: []
externalAuthors: "Jakub Sawiński"
status: published
categories:
  - GSOC
  - Open Source
...
Below is a list of ideas proposed by M-Lab for Google Summer of Code 2014. For more information about GSOC 2014, see the [official web site](https://www.google-melange.com/gsoc/homepage/google/gsoc2014).
...
- Code repository: https://github.com/m-lab
