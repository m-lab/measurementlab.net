---
permalink: new-tables-release
title: Making it Easier to Use M-Lab Data
excerpt: >-
  In January, M-Lab launched a beta test of new BigQuery tables for M-Lab data.
...
Before we move on to specifics, when we say faster performing, we mean a _lot_ faster. As in, **certain queries that used to take over 2 hours now complete in 8 seconds**. That means that playing with the data just became a lot more fun.
...
M-Lab will continue to support and update the legacy tables, but these tables are deprecated and will not see future development. To migrate your legacy queries to take advantage of M-Lab's new, faster tables, please refer to the [Legacy Migration Guide](/learn/) for details.
