---
permalink: tcp-and-bbr
title: BBR TCP and Measurement Lab
excerpt: >-
  What is TCP? Since the beginning of the its existence, the Internet has
  expanded in scope, traffic, content, and a myriad of other ways. The protocols
  that make up the Internet’s backbone have mostly remained the same since they
