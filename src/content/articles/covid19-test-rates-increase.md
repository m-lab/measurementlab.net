---
permalink: covid19-test-rates-increase
title: Changes Related to COVID-19
excerpt: >-
  As COVID-19's impact increases globally, more people are working, learning and
  living online. Internet infrastructure is critical in these moments. The
  user-initiated measurements collected by M-Lab provide an opportunity to
...
![NDT Global Test Rate (tests/min)](/src/assets/images/blog/2020-04-01/1-ndt-global-test-rate.png)
...
![Rate of Downloads in Area Surrounding New York, USA(tests/min)](/src/assets/images/blog/2020-04-01/2-ny-dl-rate.png)
...
![Rate of Downloads in Area Surrounding New York, USA(tests/min)](/src/assets/images/blog/2020-04-01/3-ny-plain-vs-wss.png)
In the US, PLAIN tests are typically run by automation and WSS tests are run interactively by people.

![Median Download Bandwidth for PLAIN tests New York, USA (Mbps)](/src/assets/images/blog/2020-04-01/4-ny-med-dl-plain.png)
...
![Median Download Bandwidth for PLAIN tests, New York, USA (Mbps)](/src/assets/images/blog/2020-04-01/5-ny-med-dl-plain-2.png)

![Median Download Bandwidth for WSS tests, New York, USA (Mbps)](/src/assets/images/blog/2020-04-01/6-ny-med-dl-wss.png)
...
![Median Download Bandwidth for WSS tests, New York, USA (Mbps)](/src/assets/images/blog/2020-04-01/7-ny-med-dl-wss-2.png)

### Area Surrounding São Paulo, Brazil

![Rate of Downloads in Area Surrounding São Paulo, Brazil (tests/min)](/src/assets/images/blog/2020-04-01/8-sao-paulo-dl-rate.png)
...
![Median Download Bandwidth for PLAIN tests, São Paulo, Brazil (tests/min)](/src/assets/images/blog/2020-04-01/9-sao-paulo-plain-vs-wss.png)
...
![Median Download Bandwidth for PLAIN tests, São Paulo, Brazil (tests/min)](/src/assets/images/blog/2020-04-01/10-sao-paulo-med-dl-plain.png)
...
![Median Download Bandwidth for PLAIN tests, São Paulo, Brazil (tests/min)](/src/assets/images/blog/2020-04-01/11-sao-paulo-med-dl-plain-2.png)

![Median Download Bandwidth for WSS tests, São Paulo, Brazil (tests/min)](/src/assets/images/blog/2020-04-01/12-sao-paulo-med-dl-wss.png)
...
![Median Download Bandwidth for WSS tests, São Paulo, Brazil (tests/min)](/src/assets/images/blog/2020-04-01/13-sao-paulo-med-dl-wss-2.png)
