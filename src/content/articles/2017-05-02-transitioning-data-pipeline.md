---
permalink: transitioning-data-pipeline
title: Transitioning to a New Backend Pipeline and Data Availability
excerpt: >-
  M-Lab data is collected from distributed experiments hosted on servers all
  over the world, processed in a pipeline, and published for free in both raw
  and parsed (structured) formats. The back end processing component for this
