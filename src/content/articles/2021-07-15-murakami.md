...
excerpt: >-
  ...
  integration by the Google Search team. While M-Lab is known for the large
  volume of crowdsourced test data resulting from people running our te...
authors:
  - lai-yi-ohlsen
  - chris-ritzo
published: published
...
[ndt-server]: /src/assets/blog/run-your-own-ndt-server/
...
[^1]:
    Federal Communications Commission. Measuring Fixed Broadband - Measuring
    Broadband America Program.
    https://www.fcc.gov/general/measuring-broadband-america-measuring-fixed-broadband

[^2]:
    Ofcom. UK home broadband performance, measurement period November 2020 - Technical
    Annex.
...
[^3]:
    Sundaresan, Srikanth; et al. Broadband Internet Performance: A View
