---
permalink: mlab-public-statement-samknows-experiment
title: Recent updates regarding the SamKnows experiment
excerpt: >-
  Measurement Lab (M-Lab) has been a supportive partner of the FCC’s Measuring
  Broadband America program since its beginning due to the program’s commitment
  to openness, open data and transparency which aligns closely with M-Lab’s
