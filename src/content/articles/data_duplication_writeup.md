---
permalink: data_duplication_writeup
title: Data Duplication Bug in M-Lab BigQuery Data
excerpt: >-
  The team working on archiving M-Lab data recently discovered that the M-Lab
...
[![median graph](/src/assets/images/blog/median-download-1.png){:style="border:1px solid black"}](/src/assets/images/blog/median-download-1.png){:target="\_blank"}
[![median graph](/src/assets/images/blog/median-download-2.png){:style="border:1px solid black"}](/src/assets/images/blog/median-download-2.png){:target="\_blank"}
...
[![rtt graph](/src/assets/images/blog/rtt-download-1.png){:style="border:1px solid black"}](/src/assets/images/blog/rtt-download-1.png){:target="\_blank"}
[![rtt graph](/src/assets/images/blog/rtt-download-2.png){:style="border:1px solid black"}](/src/assets/images/blog/rtt-download-2.png){:target="\_blank"}
...
- Worked with researchers to update the [M-Lab Observatory](/src/assets/observatory/) with the corrected data.
