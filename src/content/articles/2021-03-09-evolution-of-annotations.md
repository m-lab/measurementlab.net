---
permalink: evolution-of-annotations
title: Evolution of M-Lab's Geographic and Network Annotations
excerpt: >-
  In our recent [roadmap post][roadmap], we shared a list of milestones that the
  team is working on this and last quarter. Our Datatype migration and
  Standardized Columns milestone references the [gardener service][gardener],
