---
permalink: cloudflare-aimscoredata-announcement
title: M-Lab is now providing Cloudflare AIM data for open access
excerpt: >-
  Want to know more about your Internet connection? M-Lab is proud to announce
  that we are now publishing Cloudflare’s Aggregated Internet Measurement (AIM)
...
![logos](/src/assets/images/blog/2023-02-cloudflare/logos.png){: width="750"}
...
![IMC 2022 participants](/src/assets/images/blog/2023-02-cloudflare/speedtest-example.png){: width="750"}
