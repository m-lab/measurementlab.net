...
export default function KnowledgeBaseCard({ article, markDraft }: Props) {
  ...
  return (
    <div
      className="group relative flex h-full flex-col border-b-4 border-neutral-200 transition-colors duration-200 notch hover:border-primary-400"
    ...
    >
      <div className="flex h-full flex-col gap-4 bg-neutral-100 p-8">
        ...
        {article.description && (
          <p className="line-clamp-4 grow text-base text-neutral-600">
            {article.description}
          </p>
        )}
