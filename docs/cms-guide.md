...
> **Last updated:** February 2026 | **Pages CMS version:** 1.0.0
...
| **Sections**                    | Yes      | Department/team tags (e.g., "Leadership", "Engineering") |
...
> **Tip:** The Sections field controls where a person appears on the website. For example, selecting "Leadership" will show them in the Leadership section of the About page.
...
| **Category**     | Yes      | Partnership type (e.g., sponsor, infrastructure) |
...
> **Important:** Removing a category that is in use by existing content may cause issues. Check that no entries use a category before deleting it.
...
| **Blog Roll**          | Latest news feed                        | Title, Description, Post count, "More" button toggle           |
